        ...
        <div className="mt-10">
          ...
          <div className="space-x-2 flex">
            ...
            <p className="flex space-x-3 items-center  ">
              <span onClick={decQty} className="bg-red-500 p-3 cursor-pointer  text-xl font-bold">
                <AiOutlineMinus />
              </span>
              <span className="text-2xl font-semibold">{qty}</span>
              <span  onClick={incQty} className="bg-green-500 p-3 cursor-pointer text-xl font-bold">
                <AiOutlinePlus />
              </span>
            </p>
          </div>
