...
const Navbar = () => {
  ...
  return (
    <div className="flex h-20 bg-gray-200 text-center items-center justify-around  sticky">
      {" "}
      <p>
        <Link href="/">
          <h2 className="italic cursor-pointer text-3xl font-bold">Awsome Shop</h2>
        </Link>
      </p>
